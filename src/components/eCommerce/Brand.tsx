...
const Brand = ({ image, name }: { image: string; name?: string }) => {
  ...
  return (
    // <div
    //   className={`
    //     my-1 relative overflow-hidden w-full h-44 rounded-xl cursor-pointer
    ...
    //       ${isHovered 
    //         ? 'bg-gradient-to-br from-indigo-600/70 to-purple-600/90'
    ...
    //       <h3 
    //         className={`
    //           m-0 text-xl font-semibold text-yellow-300 transition-all duration-300 ease-in-out
    ...
    //   {/* Hover accent shine effect */}
    //   {isHovered && (
    //     <div 
    //       className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] z-10 rotate-30 animate-pulse"
    //       style={{
